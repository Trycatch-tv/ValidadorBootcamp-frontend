...
import "./index.css"
import ReportsBackofficeContainer from "./features/backoffice/reports/reports.backoffice.container.tsx";
    ...
    <BrowserRouter>
      <React.StrictMode>
        <Routes>
          ...
          <Route path="bootcamp/:id" element={<ProfileBootcampContainer />} />
          <Route path="backoffice/reports" element={<ReportsBackofficeContainer />} />
        </Routes>
      </React.StrictMode>
    </BrowserRouter>
  )
